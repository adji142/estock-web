...
class C_Satuan extends CI_Controller {
	...
	public function Read()
	{
		...
		if ($KodeSatuan == '') {
			$rs = $this->ModelsExecuteMaster->GetData('tsatuan');
		}
		else{
			$rs = $this->ModelsExecuteMaster->FindData(array('KodeSatuan'=>$KodeSatuan),'tsatuan');
		}
	...
	public function CRUD()
	{
		...
		elseif ($formtype == 'edit') {
			try {
				$rs = $this->ModelsExecuteMaster->ExecUpdate($param,array('KodeSatuan'=> $KodeSatuan),$ArticleTable);
				if ($rs) {
					$data['success'] = true;
				}
				else{
		...
		elseif ($formtype == 'delete') {
			try {
				$SQL = "DELETE FROM ".$ArticleTable." WHERE KodeSatuan = '".$KodeSatuan."'";
